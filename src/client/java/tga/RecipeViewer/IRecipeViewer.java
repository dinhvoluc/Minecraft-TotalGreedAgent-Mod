...
public abstract class IRecipeViewer {
    ...
    public abstract void DrawViewer(DrawContext context, TextRenderer textRenderer, float deltaTicks, int mouseX, int mouseY, IMousePointerSeeter mpset);

    public abstract void SetAnchor(int x, int y, IMousePointerSeeter mpset);
