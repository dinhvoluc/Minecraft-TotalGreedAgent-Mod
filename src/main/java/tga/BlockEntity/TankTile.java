...
//    }
//
//    public TankTile(BlockPos pos, net.minecraft.block.BlockState state) {
...
//        TankGuiSync payload = new TankGuiSync(world.getRegistryKey().getValue().toString(), pos, ExCount, HoldItem);
